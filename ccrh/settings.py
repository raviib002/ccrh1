...
CMS_TEMPLATES = (
    ...
    ('cms/faq.html', 'FAQ'),
    ('cms/website-policies.html', 'Website Policies'),
    ('cms/e-tutorials.html', 'E-Tutorials'),
    ('cms/data-and-tools.html', 'Data and Tools'),
    ('cms/announcements.html', 'Announcements'),
    
    ('cms/about_us/about-us.html', 'About Us'),
    ('cms/about_us/vision_mission.html', 'Vision and Mission'),
    ('cms/about_us/leadership.html', 'Leadership'),
    ('cms/about_us/editorial-board.html', 'Editorial Board'),
    ('cms/about_us/ownership.html', 'Ownership'),
    
    ('cms/why_publish_in_hccr/why-publish-in-hccr.html', 'Why Publish in HCCR'),
    ('cms/why_publish_in_hccr/advantage-of-hccr.html', 'Advantage of HCCR'),
    ('cms/why_publish_in_hccr/international-case-reporting-guidelines.html', 'International Case Reporting Guidelines'),
    ('cms/why_publish_in_hccr/loyality-programme.html', 'Loyalty Programme'),
    ('cms/why_publish_in_hccr/badges-for-physicians.html', 'Badges for Physicians'),
    ('cms/why_publish_in_hccr/badges-for-clinics.html', 'Badges for Clinics'),
    ('cms/why_publish_in_hccr/chances-to-get-publish.html', 'Chances to Get Publish'),
    
    ('cms/submission_guidelines/submission-guidelines.html', 'Submission Guidelines'),
    ('cms/submission_guidelines/case-recording-template-format.html', 'Case Recording Template Format'),
    ('cms/submission_guidelines/patient-consent-formats.html', 'Patient Consent Formats'),
    ('cms/submission_guidelines/followup-formats.html', 'Follow Up Formats'),
    ('cms/submission_guidelines/patient-outcome-scales.html', 'Patient Outcome Scales'),
